...
def signup_for_activity(activity_name: str, email: str, teacher: Dict[str, Any] = Depends(get_current_teacher)):
...
def unregister_from_activity(activity_name: str, email: str, teacher: Dict[str, Any] = Depends(get_current_teacher)):
